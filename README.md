<p align="center">
  ...
  <h5>(https://github.com/akashmaji946/ChampSim-IISc is forked from https://github.com/casperIITB/ChampSim with original credits to https://github.com/ChampSim/ChampSim. This is a publicly available and free to use repository for simulation and architectural studies. The creator can be contacted at: akashmaji@iisc.ac.in)</h5>
