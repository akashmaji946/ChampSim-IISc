<p align="center">
  ...
  <h5>(https://github.com/akashmaji946/ChampSim-IISc is forked from https://github.com/casperIITB/ChampSim with original credits to https://github.com/ChampSim/ChampSim. This is a publicly available and free to use repository for simulation and architectural studies. The creator, Akash Maji, can be contacted at: <a href="[https://akashmaji.me](https://akashmaji.me/contact.html)">akashmaji@iisc.ac.in</a>)</h5>
